...
public abstract class AbsTransport {
	 ...
	 * @throws java.io.IOException when remote host disconnects
	 */
	public abstract int read(byte[] buffer, int offset, int length) throws IOException;

	/**
	 * Writes to the transport. If the host is not yet connected, simply return without
	 * doing anything. An {@link java.io.IOException} should be thrown if there is an error after
	 * connection.
	 * @param buffer bytes to write to transport
	 * @throws java.io.IOException when there is a problem writing after connection
	 */
